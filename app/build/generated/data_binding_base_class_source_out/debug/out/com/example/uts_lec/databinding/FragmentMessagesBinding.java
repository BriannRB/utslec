...
public final class FragmentMessagesBinding implements ViewBinding {
  ...
  private FragmentMessagesBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backButton,
      @NonNull FrameLayout fragmentContainer, @NonNull RecyclerView recyclerMessages,
  ...
  public static FragmentMessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMessagesBinding((ConstraintLayout) rootView, backButton, fragmentContainer,
